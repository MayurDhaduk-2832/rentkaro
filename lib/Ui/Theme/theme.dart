...
const Color splashColor_ = Color(0xffFBC334);
...
const Color splashColorDark = Color(0xffFBC334);
...
extension ColorPrefs on ColorScheme {
  ...
  Color get splashColor =>
      _getColor(brightness, lightColor: splashColor_, darkColor: splashColorDark);
