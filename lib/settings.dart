...
class AppSettings {
  /// Basic Settings
  static const String applicationName = 'Rent karo';
...
// DON'T FORGET TO GET HTTPS:// OR HTTP:// BEFORE YOUR ADMIN PANEL URL OR HOST URL
  static const String hostUrl =
      "https://admin.rentkaro.aspirantsally.com"; // DON'T ADD / AT END
  ...
  /* this is for load data when open app if old data is already avFailable so
